...
const NAV_ITEMS: Array<{
  ...
  { index: "03", label: "Outreach",     href: "/outreach",    badge: null        },
  { index: "04", label: "Campaigns",    href: "/campaigns",   badge: null        },
  { index: "05", label: "Import",       href: "/import",      badge: null        },
  // "Blocked" is the user-facing name for the suppression list; the route,
  // API and Suppression model keep the domain term.
  { index: "06", label: "Blocked",      href: "/suppressions",badge: null        },
  { index: "07", label: "Compose",      href: "/compose",     badge: null        },
...
export default function Sidebar() {
  ...
  // Fetch the draft badge count on mount and whenever the route changes.
  useEffect(() => {
    let cancelled = false;
  ...
  const badgeCounts: Record<"drafts", number> = {
    drafts: draftCount,
  };
        ...
        {NAV_ITEMS.map(({ index, label, href, badge }) => {
          ...
          return (
            ...
            >
              ...
              {/* Amber badge — Review Queue (drafts), hidden when 0 */}
              {badge && count > 0 && (
                <span
                  style={{
